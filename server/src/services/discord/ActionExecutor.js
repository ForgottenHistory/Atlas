...
class ActionExecutor {
  ...
  async executeAction(decision, message) {
    try {
      ...
      // SIMPLIFIED: Don't use special batch handling, just route normally
      // The message object should already have the combined content from batching
  ...
  // REMOVED the complex batch handling - let ResponseAction handle it with fallbacks
